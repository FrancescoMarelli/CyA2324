...
// Contiene la función scan del proyecto que lee por teclado las notas de los alumnos
// Referencias:
// Enlaces de interés
...
void scan(std::map<std::string, float> highestGrade){
    ...
    while (exit == false) {
        //añadir por pantalla el nombre y la nota del alumno
        std::string name;
        ...
        //actualizar fichero con la nueva nota mayor
